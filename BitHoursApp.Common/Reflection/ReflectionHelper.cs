    ...
    {      
        ...
        public static bool SetPropertyValue(object destinationObject, string propertyName, object value)
        {
            ...
            if (propertyInfo == null ||
                ...
                return false;
            propertyInfo.SetValue(destinationObject, value == null ? null : value, null); // value == null ? null : value - данная махинация нужна для того, чтобы установился null нужного типа
            return true;
        }
        ...
        {
            if (obj == null) throw new ArgumentException(@"VI: parameter 'obj' can't be null");
