...
namespace BitHoursApp.Common.Wpf.ResX
{
    ...
    public class ResXExtension : ManagedMarkupExtension, IServiceProvider
    {
        ...
        private void EnsureAppResourcesLoaded()
        {
            ...
            Stream resourcesReferencesStream = resourceDescriptionAssembly.GetManifestResourceStream("BitHoursApp.Common.Wpf.ResX.resources.xml");
